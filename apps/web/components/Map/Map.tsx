...
interface ClientRect {
  ...
  useEffect(() => {
    ...
    if (!checkExistClient(lastMessage.userId)) {
      ...
      rectRefs.current.find((rect) => rect.userId === lastMessage.userId)?.rect.setBounds(new window.naver.maps.LatLngBounds(new window.naver.maps.LatLng(lastMessage.bounds.min.y, lastMessage.bounds.min.x), new window.naver.maps.LatLng(lastMessage.bounds.max.y, lastMessage.bounds.max.x)));
    }
